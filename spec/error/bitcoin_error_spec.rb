  ...
  describe ".get_exchange_rate_error" do
    context "when passed 404" do
      it "should return a string containing '404'" do
        expect(Decent::BitcoinError.get_exchange_rate_error "404").to include "404"
      end
    end

    context "when not passed 404" do
      it "should return a string" do
        expect(Decent::BitcoinError.get_exchange_rate_error "666").to include "Unknown"
      end
    end
  end
end
